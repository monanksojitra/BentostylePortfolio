...
const Navbar = () => {
  ...
  return (
    <nav className="mt-6 flex items-center justify-between w-full">
      <div className="h-11 xl:h-16 aspect-square rounded-full flex items-center justify-center bg-dark-500 outline outline-dark-400 cursor-pointer">
      ...
      <div className=" h-11 xl:h-16 mx-1 px-3 xl:px-16 rounded-3xl xl:rounded-full flex flex-1 items-center justify-between bg-dark-500 outline outline-dark-400 xl:text-xl font-bold uppercase">
        ...
        <a href="#" className="hidden  text-first  sm:block">
          Portfolio
        </a>
        <a href="#" className="hidden  text-first  sm:block">
          Contact
      ...
      {toggelmenu && (
        <div className="absolute sm:hidden top-20 right-10  bg-dark-400 rounded-2xl w-[50%]">
          <ul className="px-10 py-5 space-y-3 text-first transition-all duration-150 uppercase w-fit">
            <li className="hover:border-b-2 py-1 cursor-pointer">About</li>
            <li className="hover:border-b-2 py-1 cursor-pointer">portfolio</li>
            <li className="hover:border-b-2 py-1 cursor-pointer">contact</li>
          </ul>
        </div>
      )}
    </nav>
